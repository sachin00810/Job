  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center px-4">
      <div className="text-center max-w-md">
        ...
        <h2 className="text-xl font-bold text-slate-900 mb-2">Couldn&apos;t load jobs</h2>
        <p className="text-slate-500 text-sm mb-6">Something went wrong loading the jobs listing.</p>
